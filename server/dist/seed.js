...
const seed = async () => {
    try {
        ...
        await Promise.all([
            ...
            Listing_1.default.deleteMany({}),
            Broadcast_1.default.deleteMany({}),
            Notification_1.default.deleteMany({}),
            Chat_1.default.deleteMany({ isSupport: false }) // Keep support chat if possible, or recreate
        ]);
        console.log('Creating users...');
        const staticIds = {
            obokobong: new mongoose_1.default.Types.ObjectId('65c19d7a9f7a8b2c4d5e6f7b'),
            sarah: new mongoose_1.default.Types.ObjectId('65c19d7a9f7a8b2c4d5e6f7c'),
            david: new mongoose_1.default.Types.ObjectId('65c19d7a9f7a8b2c4d5e6f7d'),
            emeka: new mongoose_1.default.Types.ObjectId('65c19d7a9f7a8b2c4d5e6f7e')
        };
        ...
        await Broadcast_1.default.create([
            {
                author: sarah.id,
        ...
        await Chat_1.default.create({
            _id: new mongoose_1.default.Types.ObjectId('65c19d7a9f7a8b2c4d5e6f7a'), // Fixed ID for support
